...
def run_compression_pipeline():
    ...
    try:
        # Φόρτωση και Διαχωρισμός Εικόνας
        ...
        # Βήματα 2, 3, 4: Υπολογισμός SVD Matrices (U, S, V) για κάθε κανάλι 
        ...
        # Βήματα 5 & 6: Ανακατασκευή, Αποθήκευση και Αξιολόγηση 
        ...
        # Παρουσίαση Αποτελεσμάτων Πίνακα ---
        print("\n=========================================")
